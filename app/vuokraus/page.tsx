      ...
      <main>
        <section className="subhero rental-hero">
          <div className="shell subhero-grid">
            ...
            <div className="hero-visual rental-blueprint rental-client-image">
              <img src={content.media.rentalImageUrl || "/images/jkp-asiakkaan-vuokrakohde-2026-09-18.jpg"} alt="JKP Groupin oma vuokrakohde, asiakkaan toimittama valokuva" width={1536} height={1022} loading="eager" decoding="async" />
        ...
        <section className="section">
          ...
          <div className="shell" style={{ marginBottom: 32 }}>
            <img src={content.media.rentalImageUrl || "/images/jkp-asiakkaan-vuokrakohde-2026-09-18.jpg"} alt="JKP Groupin oma vuokrakohde, asiakkaan toimittama valokuva" width={1536} height={1022} loading="lazy" decoding="async" className="rental-client-inline-image" style={{ display: "block", width: "100%", height: "auto", maxHeight: 560, objectFit: "cover", borderRadius: 2 }} />
          </div>
        ...
        <section className="contact-section" id="toimitilakysely"><div className="shell contact-grid"><div><p className="eyebrow">Yrityksille</p><h2>Kerro tilatarpeesta.</h2><p>Yritys, käyttötarkoitus, tarvittava pinta-ala, sijainti ja tavoiteaikataulu riittävät ensimmäiseen arvioon.</p></div><BusinessPremisesForm /></div></section>
        <section className="section" id="vuokrahakemus"><div className="shell contact-grid"><div><p className="eyebrow">Asuntovuokraus</p><h2>Vuokralaisen hakemuslomake</h2><p>Täytä hakemus, kun olet ollut yhteydessä JKP Groupiin julkaistusta tai tarjotusta kohteesta.</p></div><ApartmentApplicationForm /></div></section>
      </main>
